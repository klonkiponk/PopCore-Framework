...
{  
    ...
    if (!isset($_SESSION['loggedin'])){
        ...
        <form action='".$_SERVER['REQUEST_URI']."' method='post'>
            ...
            <button type='submit' name='action' style='margin-top:5px;' class='button login' value='Login' >Login</button>
        ...
        echo "
            ...
            <form action='".$_SERVER['REQUEST_URI']."' method='post'>
                <button type='submit' name='action' style='margin-top:5px;' class='button logout' value='Logout' >Logout</button>
                <input type='hidden' name='sys_referring_page' value='$sys_referring_page'/>
            </form>
        ";
    }
